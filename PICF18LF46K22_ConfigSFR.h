 ...
 * Author: Jiri Konecny 
 * Version: 070420
 * Comments: SFR config bits and basic function lib for PIC
 */
...
//declared Init function
void InitDevice();
//declared Clear function
void ClearDevice();
...
*
* Description: Simple delay function, ms
* Arguments  : time - time in ms
* Returns    : none
*********************************************************************************************************
*/
...
/*
*********************************************************************************************************
* delay_NOP(unsigned int counter)
*
* Description: Simple delay function, NOP
* Arguments  : counter - delay in NOP
* Returns    : none
*********************************************************************************************************
*/
